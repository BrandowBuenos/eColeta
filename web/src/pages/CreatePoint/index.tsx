...
const CreatePoint = () => {
    ...
    const [selectedPosition, setSelectedPosition] = useState<[number, number]>([-12.657206, -39.121294]);
    ...
    /** Reaproveitei o meu selectedPosition para setar o overlay com a posição inicial da geolocalização. Se por acaso, não pegar, aí deixei estático o valor da lat e lng */
    useEffect(() => {
